...
import br.com.sgb.service.CustomerService;
...
public class CustomerController {
    ...
    @GetMapping
    public ResponseEntity<Page<ViewCustomerDto>> findAll(Pageable pageable) {
        return ResponseEntity.ok(customerService.findAll(pageable));
    }

    @GetMapping("/{idClient}")
    public ResponseEntity<CustomerDto> findById(@PathVariable Long idClient) {
        return ResponseEntity.ok(customerService.findById(idClient));
    }
    ...
    public ResponseEntity<Void> deleteById(@PathVariable Long idClient) {
        customerService.deleteById(idClient);
